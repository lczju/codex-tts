...
- `AISHELL-3`：已落地，作为第一轮 baseline 数据来源
- `Biaobei / DataBaker`：保留为后续补充或替代路线
- `LJSpeech`：仅作为英文实验备用，不是当前主线
...
| LJSpeech | 英文 | 单说话人 TTS | 英文备用 | 中 | 不适合当前中文主线 |
